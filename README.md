...
```sh
git clone https://github.com/CristianoFIlho/chatbot.git
```
...
[https://github.com/CristianoFIlho/clinica-erasmo-moneto.git](https://github.com/CristianoFIlho/clinica-erasmo-moneto.git)

## 🧙‍♂️ Contribution

1. Make the _fork_ of the project (<https://github.com/CristianoFIlho/clinica-erasmo-moneto/fork>)
